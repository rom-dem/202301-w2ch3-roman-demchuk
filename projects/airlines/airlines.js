...
let dailyFlights = () => {
            for (i = 0; i < flights.length; i++){
                ...
                console.log("The flight from: 🛫 " + flights[i].from + " to: 🛬 " + flights[i].to + " costs: " + flights[i].cost + " €" +" and it has layovers.")
        } else {
            console.log("The flight from: 🛫 " + flights[i].from + " to: 🛬 " + flights[i].to + " costs: " + flights[i].cost + " €" +" and it's a direct flight.")
        }
    }
}
        dailyFlights();
